(function () {
    ...
    function getOutline() {
        for (var e = 0, t = document.querySelectorAll('h1,h2,h3,h4,h5,h6,h7,[role="heading"]'), i = [], o = 0; o < t.length; o++) {
            var n = t[o], l = isVisible(t[o]),
                r = parseInt("heading" == n.getAttribute("role") && n.getAttribute("aria-level") || n.nodeName.substr(1));
            if (l) {
                var d = r > e && r !== e + 1;
                e = r
            } else d = !1;
            i.push({ visible: l, visuallyhidden: l && isVisuallyHidden(n), wrong: d, level: r, el: n })
        }
        return i
    }
    ...
    function handleElementHover(e) {
        for (var t = e.target, i = document.body.querySelectorAll("*"), o = !1, n = i.length - 1; n >= 0; n--) {
            var l = i[n];
            if (o) {
                for (var r = outline.length - 1; r >= 0; r--) if (outline[r].el === l && outline[r].visible) return highlightElement(outline[r].el, !0), void highlightLink(doc.querySelector('#headings a[href="#' + r + '"]'))
            } else l === t && (o = !0, n++)
        }
        highlightLink(null)
    }
    ...
    container.appendChild(iframe), iframe.onload = function () {
        function e(e, t) {
            var i = doc.getElementById(e), o = doc.querySelector(".result");
            if (i) {
                var n = function (e) {
